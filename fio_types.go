...
/*
FIO Json parsing structures from kubestr [1].
- Added the Latency Percentile struct

[1] https://github.com/kastenhq/kubestr/blob/c995d458da92a7631bf424bb891d37b67195a245/pkg/fio/fio_types.go
...
type FioNS struct {
	...
	Percentile FioLatPercentile `json:"percentile,omitempty"`
}
type FioLatPercentile struct {
	Percentile100  int64 `json:"1.000000,omitempty"`
	Percentile500  int64 `json:"5.000000,omitempty"`
	Percentile1000 int64 `json:"10.000000,omitempty"`
	Percentile2000 int64 `json:"20.000000,omitempty"`
	Percentile3000 int64 `json:"30.000000,omitempty"`
	Percentile4000 int64 `json:"40.000000,omitempty"`
	Percentile5000 int64 `json:"50.000000,omitempty"`
	Percentile6000 int64 `json:"60.000000,omitempty"`
	Percentile7000 int64 `json:"70.000000,omitempty"`
	Percentile8000 int64 `json:"80.000000,omitempty"`
	Percentile9000 int64 `json:"90.000000,omitempty"`
	Percentile9500 int64 `json:"95.000000,omitempty"`
	Percentile9900 int64 `json:"99.000000,omitempty"`
	Percentile9950 int64 `json:"99.500000,omitempty"`
	Percentile9990 int64 `json:"99.900000,omitempty"`
	Percentile9995 int64 `json:"99.950000,omitempty"`
	Percentile9999 int64 `json:"99.990000,omitempty"`
}
